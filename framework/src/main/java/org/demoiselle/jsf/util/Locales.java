...
/**
 * <p>
 * Session sciped managed bean that can configure
 * the VIEW layer locale settings.
 * </p>
 *
 * <p>
 * This class is {@link Named}, meaning it can be accessed
 * in JSF pages through the 'locales' attribute. For example, if you need
 * to know what is the current configured locale on a faces pages you
 * only need to do:
 * </p>
 *
 * <pre>
 * &lt;h:outputText value="#{locales.currentLocale}"/&gt;
 * </pre>
 * 
 * @author SERPRO
 * */
...
public class Locales implements Serializable {
	 ...
	 * into an instance of {@link Locale} and then {@link #setCurrentLocale(Locale locale)} will
	 ...
	 * session defined a different locale using {@link #setApplicationLocale(Locale)}).
	 * 
