...
import org.demoiselle.internal.implementation.AnnotatedMethodProcessor;
import org.demoiselle.lifecycle.LifecycleAnnotation;
...
public abstract class AbstractLifecycleBootstrap<A extends Annotation> implements Extension {
	...
	public <T> void processAnnotatedType(@Observes @WithAnnotations(LifecycleAnnotation.class) final ProcessAnnotatedType<T> event) {
